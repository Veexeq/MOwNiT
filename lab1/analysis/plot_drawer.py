...
PRECISIONS = ['0.100000000000000000001',
...
def create_plot(data, compiler, precision, variant):
    ...
    # Label the plot
    formula = f'$x_{{k+1}} = x_k + 3x_k(1 - x_k), x_0 = {precision}$' if variant == 'basic' else f'$x_{{k+1}} = 4x_k - 3x_k^2$'
...
create_plot(df_gcc, 'GCC', PRECISIONS[0], VARIANTS[0])
